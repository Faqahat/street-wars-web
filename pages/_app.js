    ...
    <div className="cursor-default h-screen  scrollbar-thin selection:bg-black selection:text-white">
      ...
      <div className="grid md:grid-cols-2  min-h-screen ">
        <div className="col-span-1 ">
          ...
          <div className="bg-white   ">
            <div className="max-w-full">
              <div className="sm:ml-20 md:ml-8 md:flex  lg:show text-center">
                <button className=" lg:hidden mb-5   bg-[#644d8a] text-white text-xl font-bold border-white  p-3  sm:w-44 sm:mr-20 md:text-center md:w-36   md:mr-1 lg:w-72 lg:mr-10  h-14 mt-8">
                  Join Discord
                </button>
              ...
              <div className=" lg:px-0 ml-10 mr-10 lg:mr-24 ">
                ...
                <p className=" text-black sm:text-l  text-justify  font-sans xl:text-xl">
                  ...
                  fostering an environment with a member-centric approach where
                  all players have equal potential for in game success and
                  community recognition. Operating since 2011 LS Street Wars is
                  one of the few remaining Gang Wars Server on SA:MP. We plan to
                  keep the server running for now and in the near future. We are
                  closely following OpenMP development and in process of
                  migrating our server to OpenMP. Join our discord server to
                  stay updated.
                </p>
                <p></p>
                <div className="flex">
                  <div className="mt-4 sm:mt-6  ">
                    <div className="flex flex-col md:flex-row">
                      <Tippy content="Connect to The Server">
                        <Link href="samp://217.182.46.69:7777">
                          <button className="  py-2 mb-4 px-2 md:px-4 cursor-pointer  hover:bg-[#644d8a]  bg-[#6C5C86] font-semibold font-grotesk  text-sm text-white  sm:text-base md:text-2xl md:mb-4 lg:mt-6   ">
                            <span className=" flex  justify-center items-center lg:text-lg md:text-sm sm:text-xs align-middle ">
                              Connect Now <RightIcon className="ml-2 " />
                            </span>
                          </button>
                        </Link>
                      </Tippy>
                      <div className="flex justify-center  md:justify-left items-center ">
                        ...
                        >
                          <CopyToClipboard text="217.182.46.69:7777">
                            <span
                              ref={selectRef}
                              className=" flex text-sm  underline decoration-dotted  underline-offset-4 text-gray-400 cursor-pointer hover:text-gray-700"
                            >
                              Copy IP address{" "}
                              <CopyIcon className="ml-1 mt-1 " />
                            </span>
                          </CopyToClipboard>
                        </Tooltip>
                      </div>
                    ...
                    <div className="flex  my-6  items-center  md:mt-3 pb-4  lg:mt-6   ">
                      ...
                      {info?.maxplayers && isLoaded ? (
                        <span className=" flex -mt-[5px]">
                          <p className="text-gray-600    text-xs  md:ml-1   ml-2 lg:text-base 2xl:text-lg  ">
                            Server is Online.
                          </p>

                          <p className="text-gray-600   ml-1 text-xs  md:ml-1  md:text-xs lg:ml-1    lg:text-base 2xl:text-lg ">
                            <span className="font-bold bg-black text-white py-1 px-2 font-mono">
                              {" "}
                              {info?.online + " / " + info?.maxplayers}
                            </span>{" "}
                            Players Online
                          </p>
                        </span>
                      ) : (
                        <span className="blur-md bg-neutral-400 ml-4 animate-pulse text-gray-600  text-xs  md:ml-1  md:text-xs lg:ml-1    lg:text-base 2xl:text-lg">
                          XXXXXXXXXXXXX 888/888 XXXXXXXXXX
                        </span>
                      )}{" "}
                      {/*Placeholder Blur*/}
                    </div>
          ...
          <span className="flex justify-center md:justify-end  mr-10 mb-6 text-gray-500 text-sm">
            {" "}
            <Tooltip
              content="current gamemode version"
              color="invert"
              placement="top"
            >
              {" "}
              <>
                {info.version ? (
                  ...
                  <span className="blur-md bg-neutral-400">v00.00.0</span>
                )}
              </>
            </Tooltip>
          </span>
        ...
        <div className="hidden md:block h-full w-full relative ">
          <Image
            ...
            objectFit="cover"
            className=" -z-50 grayscale"
            quality={70}
            placeholder="blur"
          />
          <div className=" hidden ml-[60%] mr-[20px] lg:flex object-right-top transform">
            <Link href="https://discord.gg/Zt6HnHbwRc">
              <button className="btn bg-[#644d8a] hover:bg-gray-700 text-white text-xl font-bold font-grotesk border-white  lg:w-60 lg:mr-10 h-14 mt-8">
                {" "}
                Join Discord
              </button>
            </Link>
